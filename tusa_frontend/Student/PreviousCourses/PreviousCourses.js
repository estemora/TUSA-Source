...
import './PreviousCoursesstyles.css';
...
function Preferences() {
  ...
  const handleInputChange = (e) => {
    ...
    if (value.trim() !== '') {
      axios.get(`http://www.cs.transy.edu/TUSA/js-login/front/build/showPreviousCourseOptions.cgi?query=${value}&username=${formData.username}`)
        .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post(`http://www.cs.transy.edu/TUSA/js-login/front/build/PreviousCourses.cgi`, {
      ...
      <div className="below-prev-nav">
        ...
        <main>
          <section className="title">
            <p className="title-text"> ADD PREVIOUS COURSES </p>
          </section>
        </main>
      </div>
