...
function DeclareMajor() {
  ...
  const submitForm = async (event) => {
    ...
    if (!major || major === '') {
      alert('Please select a major and/or minor before submitting.');
      return; 
    }
    try {
      if (major) {
      ...
      <div className="below-nav">
        ...
        <main>
          <section className="title">
              <p className="title-text"> DECLARE MAJOR(S) </p>
          </section>
        </main>
        <br />
        <div className="declare-section">
          <form className="declare-form" onSubmit={submitForm}>
            ...
            <button type="submit" className="declare-button">Submit Declaration</button>
          </form>
        </div>
