    ...
    <div>
      ...
      <NavBar />
        <main>
          ...
          <Link to="/student-voting" className="vote-course-link">CLICK HERE TO VOTE FOR COURSES</Link>
          <div className="info-section">
          <Link to="/student-faqs" className="info-card">
          <div>
            <h3>FAQs</h3>
            <img src="./FAQ.png" alt="FAQs" />
          </div>
        </Link>
        <Link to="/student-calendar" className="info-card">
              <div>
                <h3>Calendar</h3>
            ...
            <Link to="/student-about" className="info-card">
              <div>
                <h3>About</h3>
