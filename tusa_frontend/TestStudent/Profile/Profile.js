      ...
      <div className="below-nav">
        ...
        <div className="profile-left">
          ...
          <div className="status-info">
            {profileData && (
              <p> 
                Anticipated Graduation Date: {editMode ? <input type="text" name="anticipatedGradYear" value={profileData.anticipatedGradYear} onChange={handleInputChange} /> : profileData.anticipatedGradYear} <br />
                <br /> <br /> <br /> 
                Majors: {profileData.majors} <br /> 
                <br /> <br /> <br /> 
                Class Status: {editMode ? (
                  <select name="classStatus" value={profileData.classStatus} onChange={handleInputChange}>
                  ...
                  profileData.classStatus
                )} <br />
              </p>
            )}
          </div>
          <div className="picture-info">
            <img id="grad-cap" src="./gradCap.png" alt="Graduation Cap" /> <br/> <br/>
            <img id="scroll" src="./Scroll.png" alt="Scroll" />
            <br /> <br/>
            <img id="calendar" src="./CalendarProfile.png" alt="Calendar" />
          </div>
        </div>
      </div>
    </div>
