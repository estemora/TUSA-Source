...
def read_profile(filename):
    ...
    return degree, status, track, min_credit, max_credit, course_taken_unit, fullOrPartTime, currentSemester, currentYear, instructionalStyle, program, courseId, foreignLanguage
...
if __name__ == "__main__":
    ...
    try:
        ...
        if connection.is_connected():
            ...
            degree, status, track, min_credit, max_credit, course_taken_unit, fullOrPartTime, currentSemester, currentYear,  instructionalStyle,  program, courseId, foreignLanguage = read_profile(filename)
            ...
            # CSP
            CSP = csp.csp(degree, status, track, min_credit, max_credit, course_taken_unit, course_list, fullOrPartTime, currentSemester, currentYear, instructionalStyle, program, courseId, foreignLanguage, prerequisites, required_program_courses, username, electives)
